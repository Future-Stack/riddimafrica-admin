...
const revenueData = [
  { name: "Mon", revenue: 1.1, commission: 0.71 },
  { name: "Tue", revenue: 1.6, commission: 1.84 },
  { name: "Wed", revenue: 1.3, commission: 0.84 },
  { name: "Thu", revenue: 2.1, commission: 1.36 },
  { name: "Fri", revenue: 2.9, commission: 1.88 },
  { name: "Sat", revenue: 3.15, commission: 2.05 },
  { name: "Sun", revenue: 2.4, commission: 1.56 },
];
    ...
    return (
      <div className="bg-[#14b8a6] text-white px-4 py-3 rounded-lg border-0 shadow-md min-w-[160px]">
        <p className="font-extrabold text-xs uppercase tracking-wider">
          {data.name === "Tue" ? "TUE" : data.name.toUpperCase()}
        </p>
        <p className="text-xs text-teal-50 font-medium mt-1">
          Revenue:{" "}
          <span className="font-bold">UGX {data.revenue.toFixed(2)}M</span>
        </p>
        <p className="text-xs text-teal-50 font-medium mt-0.5">
          Commission:{" "}
          <span className="font-bold">UGX {data.commission.toFixed(2)}M</span>
        </p>
      </div>
    );
  }
    ...
    <CardContainer>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 ">
        <CardSectionHeader
          ...
          description="Revenue vs Platform Commission"
        />
        ...
        <div className="flex items-center gap-4 text-xs font-normal text-[#787A7F] font-inter">
          ...
          <div className="flex items-center gap-1.5">
            <span className="w-3 h-3 rounded-full bg-offYellow" />
