...
export function CategoryFormModal({ isOpen, mode, initialValues, onClose, onSubmit }: CategoryFormModalProps) {
    ...
    return (
        <ModalShell
            ...
            subtitle={isEdit ? "Update this product category" : "Create a new product category"}
        ...
        >
            ...
            <div className="mb-4">
                <label className="mb-1.5 block text-sm font-medium text-[#787A7F] leading-5 ">Category Name *</label>
                <input
                    value={values.name}
