...
const DEFAULT_VALUES: CollectionFormValues = { name: "", description: "", active: true };

export function CollectionFormModal({ isOpen, mode, initialValues, onClose, onSubmit }: CollectionFormModalProps) {
    const [values, setValues] = useState<CollectionFormValues>(initialValues ?? DEFAULT_VALUES);
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between mb-5">
                <div>
                    <p className="text-base font-medium text-[#101828] leading-6">Active</p>
                    <p className="text-xs text-[#787A7F] font-medium leading-4">Visible to sellers when listing products</p>
                </div>
                <button
            ...
            <div className="mb-4">
                <label className="mb-1.5 block text-sm font-medium text-[#787A7F] leading-5 ">Name *</label>
                <input
                    value={values.name}
            ...
            <div className="mb-6">
                <label className="mb-1.5 block text-sm font-medium text-[#787A7F] leading-5 ">Description</label>
                <textarea
