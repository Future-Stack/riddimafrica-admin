    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
            <div className="bg-white rounded-2xl w-full max-w-md p-6 font-inter shadow-xl">
                ...
                <p className="text-sm text-gray-500 mb-4">Collections group products for the buyer app</p>
                ...
                <div className="mb-4">
                    <label className="mb-1 block text-sm font-medium text-[#101828]">Name *</label>
                    <input
                        value={values.name}
