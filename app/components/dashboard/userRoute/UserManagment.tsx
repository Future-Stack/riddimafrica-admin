...
export function UserManagementSection() {
    ...
    const [loginActivityFilter, setLoginActivityFilter] = useState<"All" | "High" | "Low">("All");
    ...
    const filteredUsers = useMemo(() => {
        return users.filter((u) => {
            ...
            return matchesSearch && matchesStatus && matchesCountry && matchesActivity;
        });
                    ...
                    <div ref={filterRef} className="relative">
                        ...
                        {filterOpen && (
                            <div className="absolute right-0 mt-2 w-64 bg-white border border-gray-200 rounded-xl shadow-lg p-4 z-10">
                                ...
                                <p className="text-xs font-semibold text-gray-400 mb-2">Country</p>
                                <div className="flex flex-wrap gap-2 mb-4">
                                    {countryOptions.map((c) => (
                                        <button
                                            ...
                                            className={`px-3 py-1 rounded-full text-xs border ${countryFilter === c ? "bg-[#0a192f] text-white border-[#0a192f]" : "bg-white text-gray-500 border-gray-200"
                                                }`}
                                        >
                                            {c}
                                        </button>
                                ...
                                <p className="text-xs font-semibold text-gray-400 mb-2">Login Activity</p>
                                <div className="flex flex-wrap gap-2">
                                    {(["All", "High", "Low"] as const).map((a) => (
                                        <button
                                            ...
                                            className={`px-3 py-1 rounded-full text-xs border ${loginActivityFilter === a ? "bg-[#0a192f] text-white border-[#0a192f]" : "bg-white text-gray-500 border-gray-200"
                                                }`}
                                        >
