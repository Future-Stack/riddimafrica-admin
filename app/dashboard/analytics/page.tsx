...
import { MiniStatRow } from "@/app/features/dashboard/components/MiniStachip";
import OrdersByCitySection from "@/app/features/dashboard/components/OrdersByCitySection";
import { RankedBarChart } from "@/app/features/dashboard/components/RankedBarChart";
import {
  TopPerformingProductsSection,
  TopProductRow,
} from "@/app/features/dashboard/components/TopPerformingProducts";
          ...
          <RankedBarChart
            ...
            footer={
              <div className="space-y-2 mt-3">
                {["Burna Boy", "Burna Boy", "Burna Boy", "Burna Boy"].map(
                  (name, i) => (
                    <div
                      key={i}
