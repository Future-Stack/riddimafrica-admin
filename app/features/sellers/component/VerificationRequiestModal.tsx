    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/40 px-4">
      <div className="bg-white rounded-2xl w-full max-w-3xl p-6 font-inter shadow-xl">
        <div className="flex items-start justify-between mb-1">
          <h2 className="text-xl md:text-2xl  font-bold text-titleColor leading-7 font-inter">
            Verification Badge Review
          </h2>
          <button
            onClick={onClose}
            className="text-brown-400 hover:text-black cursor-pointer"
            aria-label="Close"
          >
            <CircleX size={20} />
          </button>
        ...
        <div className="grid grid-cols-2 gap-x-16 gap-y-4 mb-5 bg-[#F9F5EF] p-5 rounded-xl mb-6">
          <div>
            <p className="text-sm font-medium font-inter leading-5 text-black mb-2">
              Seller Profile
            </p>
            <div className="space-y-2.5 ">
              <div className="flex justify-between text-xs font-medium font-inter border-b border-[#181B1F1A] pb-1.5">
                <span className="text-gray leading-4.5">Name</span>
                <span className="text-sm font-medium font-inter leading-5 text-black ">
                  {data.name}
                </span>
              </div>
              <div className="flex justify-between text-xs font-medium font-inter border-b border-[#181B1F1A] pb-1.5">
                <span className="text-gray leading-4.5">Handle</span>
                <span className="text-sm font-medium font-inter leading-5 text-black ">
                  @{data.handle}
                </span>
              </div>
              <div className="flex justify-between text-xs font-medium font-inter border-b border-[#181B1F1A] pb-1.5">
                <span className="text-gray leading-4.5">Email</span>
                <span className="ttext-sm font-medium font-inter leading-5 text-black ">
                  {data.email}
                </span>
              </div>
              <div className="flex justify-between text-xs font-medium font-inter border-b border-[#181B1F1A] pb-1.5">
                <span className="text-gray leading-4.5">Phone</span>
                <span className="text-sm font-medium font-inter leading-5 text-black ">
                  {data.phone}
                </span>
              </div>
          ...
          <div>
            ...
            <div className="space-y-2.5">
              <div className="flex justify-between text-xs font-medium font-inter border-b border-[#181B1F1A]">
                <span className="text-gray leading-4.5">Business</span>
                <span className="text-sm font-medium font-inter leading-5 text-black  text-right">
                  {data.business}
                </span>
              </div>
              <div className="flex justify-between text-xs font-medium font-inter border-b border-[#181B1F1A]">
                <span className="text-gray leading-4.5">Type</span>
                <span className="text-sm font-medium font-inter leading-5 text-black  text-right">
                  {data.businessType}
                </span>
              </div>
              <div className="flex justify-between text-xs font-medium font-inter border-b border-[#181B1F1A]">
                <span className="text-gray leading-4.5">Payment Method</span>
                <span className="text-sm font-medium font-inter leading-5 text-black ">
                  {data.paymentMethod}
                </span>
              </div>
              <div className="flex justify-between text-xs font-medium font-inter border-b border-[#181B1F1A]">
                <span className="text-gray leading-4.5">Account</span>
                <span className="text-sm font-medium font-inter leading-5 text-black ">
                  {data.accountMasked}
                </span>
              </div>
        ...
        <p className="text-base sm:text-lg font-sbold text-gray font-inter leading-7 mb-4">
          Submitted Documents
        </p>
