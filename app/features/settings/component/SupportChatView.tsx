    ...
    <div className="flex flex-col lg:flex-row h-screen bg-[#FAF7F3] p-6 overflow-hidden">
      ...
      <div className="w-full lg:w-80 bg-white border-r border-gray-100 flex flex-col h-auto lg:h-full">
        ...
        <div className="p-4 border-b border-gray-100 flex items-center gap-2 lg:hidden">
          ...
          <span className="font-bold text-sm text-[#3c182f]">
            Back to Tickets
          </span>
        </div>
        ...
        <div className="p-4">
          <div className="relative mb-5">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-3.5 bg-white border border-gray-50 rounded-full text-sm text-gray focus:outline-none focus:ring-2 focus:ring-[#E6A40026] focus:border-transparent"
            />
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="text-base font-medium text-[#1A0D07] leading-6 truncate">
                    {t.userName}
                  </h4>
      ...
      <div className="flex-1 flex flex-col h-full bg-[#efefef]">
        ...
        <div className="bg-white p-4 flex items-center justify-between border-b border-[#C1D1D333]">
          <div className="flex items-center gap-3">
            <button
              onClick={onBackToTable}
              className="hidden lg:flex p-2 hover:bg-gray-100 rounded-full"
            >
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-base font-medium text-[#1A0D07] leading-6 ">
          ...
          <div className="relative">
            ...
            >
              ...
              >
                <path
                  d="M5.66659 13.4587H5.33325C2.66659 13.4587 1.33325 12.7503 1.33325 9.20866V5.66699C1.33325 2.83366 2.66659 1.41699 5.33325 1.41699H10.6666C13.3333 1.41699 14.6666 2.83366 14.6666 5.66699V9.20866C14.6666 12.042 13.3333 13.4587 10.6666 13.4587H10.3333C10.1266 13.4587 9.92658 13.5649 9.79992 13.742L8.79992 15.1587C8.35992 15.782 7.63992 15.782 7.19992 15.1587L6.19992 13.742C6.09325 13.5862 5.84659 13.4587 5.66659 13.4587Z"
                  stroke="white"
                ...
                />
                <path
                  d="M4.66675 5.66699H11.3334"
                  stroke="white"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
                <path
                  d="M4.66675 9.20801H8.66675"
                  stroke="white"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
