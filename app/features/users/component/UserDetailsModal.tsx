    ...
    >
      <div className="mb-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4">
          <h3 className="text-base sm:text-lg font-medium text-titleColor font-inter leading-7 mb-3">
            Account Information
          </h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-8 text-sm font-inter">
          <div>
            <span className="block text-sm font-inter font-medium text-[#6D4C41] leading-5">
              Name
            </span>
          ...
          <div>
            ...
            <span className="font-medium text-[#3E2723]">{user.email}</span>
          </div>
          <div>
            <span className="block text-sm font-inter font-medium text-[#6D4C41] leading-5">
              Status
            </span>
            <span className="font-medium  text-[#3E2723]">{user.status}</span>
          </div>
          <div>
            <span className="block text-sm font-inter font-medium text-[#6D4C41] leading-5">
              Country
            </span>
            <span className="font-medium text-[#3E2723]">{user.country}</span>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex justify-between items-center bg-[#FAF6F0] px-4 py-3 rounded-lg border border-[#F4EFE6] text-sm">
            <span className="text-titleColor leading-5  ont-normal">
              Last Login
            </span>
            <span className="text-titleColor leading-5  font-medium">
              {user.lastLogin}
      ...
      <button
        ...
        className="w-full rounded-xl bg-[#D4183D] py-3.5 text-center text-sm font-bold text-white hover:bg-[#B5122F] transition-colors cursor-pointer"
      >
        Suspend Account
      </button>
    </ModalShell>
